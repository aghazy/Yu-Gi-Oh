...
public class PublicTests {
	...
	public void testFileNotFound1TimeMonsters() throws Exception {
		...
		for (int d = 0; d < 20; d++) {
			...
			String monstersPath = eg.edu.guc.yugioh.board.player.Field
					.getMonstersPath();
			String spellsPath = eg.edu.guc.yugioh.board.player.Field
					.getSpellsPath();
			...
			try {
				...
				eg.edu.guc.yugioh.board.player.Field
						.setMonstersPath(monstersPath);
				eg.edu.guc.yugioh.board.player.Field.setSpellsPath(spellsPath);
	...
	public void testMissingFieldExceptionMonsters() throws Exception {
		...
		for (int d = 0; d < 20; d++) {
			...
			try {
				...
				eg.edu.guc.yugioh.board.player.Field
						.setMonstersPath("DoNotChangeThisFile1.csv");
	...
	public void testUnknownSpellCardException() throws Exception {
		...
		for (int d = 0; d < 20; d++) {
			...
			try {
				...
				eg.edu.guc.yugioh.board.player.Field
						.setSpellsPath("DoNotChangeThisFile2.csv");
	...
	public void testUnknownCardTypeExceptionSpells() throws Exception {
		...
		for (int d = 0; d < 20; d++) {
			...
			try {
				...
				eg.edu.guc.yugioh.board.player.Field
						.setSpellsPath("DoNotChangeThisFile1.csv");
